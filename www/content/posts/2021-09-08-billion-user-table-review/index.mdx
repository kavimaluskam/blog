...
contents, and exploitation of user's data without user's consensus.

<div class="Image__Small">
  <img src="./images/mark-zuckerberg-and-im-sorry.gif" alt="its not only your fault" />
...
<div class="Image__Small">
  ...
  />
  <figcaption>
    An example DAG from <a href="https://medium.com/airbnb-engineering/how-airbnb-achieved-metric-consistency-at-scale-f23cc53dea70">Airbnb blog post</a>, so which portion of data should we put on chain?</figcaption>
</div>
