---
title: Start your real-time pipeline with Apache Kafka
date: 2019-02-08
...
<div class="Image__Medium">
  ...
  />
  <figcaption>“Same same but different”, Kafka Connect makes stream handling easier.
</figcaption>
</div>
...
<div class="Image__Medium">
  <img
    src="./images/docker-ps.png"
    alt="docker-ps"
  />
  <figcaption>Output from the command “docker ps” — you can see the Kafka cluster is now ready.</figcaption>
</div>
...
<div class="Image__Medium">
  <img
    ...
    alt="kafdrop"
  />
  <figcaption>Kafdrop Interface, showing the status of the Kafka cluster.</figcaption>
</div>
...
<div class="Image__Medium">
  <img
    src="./images/schema-registry-ui.png"
    alt="schema-registry-ui"
  />
  <figcaption>Schema Registry UI, showing the details of available schemas.</figcaption>
</div>
...
<div class="Image__Medium">
  <img
    src="./images/sean.jpeg"
    alt="sean bean"
  />
  <figcaption>Especially when we can sneak into our company's AWS account.</figcaption>
</div>
...
<div class="Image__Medium">
  <img
    src="./images/vpc-dashboard.png"
    alt="vpc-dashboard"
  />
  <figcaption>Created VPC and subnets can be viewed in the VPC dashboard</figcaption>
</div>
...
<div class="Image__Medium">
  <img
    ...
    alt="cf1"
  />
  <figcaption>CloudFormation dashboard shows deployment stack’s status and details</figcaption>
</div>
...
<div class="Image__Medium">
  <img
    ...
    alt="cf2"
  />
  <figcaption>CloudFormation dashboard also shows deployment progress and events</figcaption>
</div>
